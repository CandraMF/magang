        ...
        <div class="card outline-dashed outline mt-5 card-custom mb-5 shadow-none">
            <div :class="{'overlay overlay-block rounded' : loading}">
                ...
                <div class="card-body pt-2 px-6 overlay-wrapper">
                    <div>
                        <SekolahForm ref="myForm" @finish-init="handleFinishInit" @success="handleSuccess" :data="formData"/>
                    </div>
                </div>
...
<script setup lang="ts">
    ...
    import SekolahForm from './forms/SekolahForm.vue';
    ...
    const modalTitle = ref('Tambah Sekolah');
    ...
    const handleSuccess = (payload) => {
        router.push({ name: 'admin-sekolah', query: { redirect: '/admin/sekolah' } });
    }
