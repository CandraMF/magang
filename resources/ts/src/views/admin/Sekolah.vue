            ...
            <div :class="{'overlay overlay-block rounded' : loading}">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <router-link to="/admin/sekolah/form" >
                            <el-button :loading="loading" type="primary" icon="el-icon-plus text-white">Tambah Sekolah/Universitas</el-button>
                        </router-link>
                    </div>
                            ...
                            <el-table-column align="right" width="250">
                                ...
                                <template #default="scope">
                                    <el-button-group :loading="loading">
                                        ...
                                        <el-button type="danger" size="small" icon="el-icon-delete text-white" @click="performDelete(scope.row.school_id)"></el-button>
                                    </el-button-group>
                                </template>
                            </el-table-column>
                        </el-table>
...
<script setup lang="ts">
    ...
    const getData = async (perPage: Number | null, page: Number | null) => {
        ...
        await axios.get('/sanctum/csrf-cookie').then(async (response) => {
            await axios.get('/api/school?perPage='+perPage+'&page='+page, {
                headers: {'Authorization': 'Bearer '+ token},
            })
            .then((response)=> {
                list.value = [];
