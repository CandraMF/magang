<template>
    ...
    <div :class="{'row d-flex justify-content-center m-0 p-0' : this.$route.name != 'berandaLdap'}">
        <div :class="{'col-md-6 mt-10' : this.$route.name != 'berandaLdap'}">
            <el-card class="p-10" >
                <h2 class="mb-5 text-center">Masuk Admin</h2>
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="top" status-icon>
                    ...
                    <div class="w-100 text-end mb-5">Bukan Admin? <router-link to="login#content">Masuk</router-link></div>
